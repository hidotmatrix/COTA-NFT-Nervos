...
const TestnetInfo = {
  ...
  AlwaysSuccessLockScript: {
    codeHash:
      "0x1157470ca9de091c21c262bf0754b777f3529e10d2728db8f6b4e04cfc2fbb5f",
    hashType: "data",
    args: "0x",
  },
  ...
  AlwaysSuccessLockDep: {
    outPoint: {
      txHash:
        "0x46a7625a76cf7401eff1dfe4f46138be69316518c9771c9f780a428843c6b5b1",
      index: "0x0",
    },
    depType: "code",
  },
...
const MainnetInfo = {
  ...
  AlwaysSuccessLockDep: {
    outPoint: {
      txHash:
        "0x81e22f4bb39080b112e5efb18e3fad65ebea735eac2f9c495b7f4d3b4faa377d",
      index: "0x0",
    },
    depType: "code",
  },
...
export function getRegistryTypeScript(isMainnet = false) {
  return isMainnet
    ? MainnetInfo.RegistryTypeScript
    : TestnetInfo.RegistryTypeScript;
}

export const getCotaCellDep = (isMainnet = false) =>
  isMainnet ? MainnetInfo.CotaTypeDep : TestnetInfo.CotaTypeDep;

export const getAlwaysSuccessLock = (isMainnet = false) =>
  isMainnet
    ? MainnetInfo.AlwaysSuccessLockScript
    : TestnetInfo.AlwaysSuccessLockScript;

export const getAlwaysSuccessCellDep = (isMainnet = false) =>
  isMainnet
    ? MainnetInfo.AlwaysSuccessLockDep
    : TestnetInfo.AlwaysSuccessLockDep;
