...
exports.generateClaimUpdateCotaTx = void 0;
const ckb_sdk_utils_1 = require("@nervosnetwork/ckb-sdk-utils");
const constants_1 = require("../../constants");
const generateClaimUpdateCotaTx = (service, cotaLock, withdrawalLock, nfts, fee = constants_1.FEE, isMainnet = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const claimUpdateReq = {
        lockScript: (0, ckb_sdk_utils_1.serializeScript)(cotaLock),
        withdrawalLockScript,
        nfts,
    };
    const { smtRootHash, claimUpdateSmtEntry, withdrawBlockHash } = yield service.aggregator.generateClaimUpdateCotaSmt(claimUpdateReq);
    ...
    rawTx.witnesses = rawTx.inputs.map((_, i) => i > 0 ? '0x' : { lock: '', inputType: `0x07${claimUpdateSmtEntry}`, outputType: '' });
    return rawTx;
});
exports.generateClaimUpdateCotaTx = generateClaimUpdateCotaTx;
